...
/* harmony export */   PrimaryLinks: () => (/* binding */ PrimaryLinks),
/* harmony export */   SampleButton: () => (/* binding */ SampleButton),
/* harmony export */   SecondaryLinks: () => (/* binding */ SecondaryLinks),
...
PrimaryLinks.parameters = {
  ...PrimaryLinks.parameters,
  docs: {
    ...PrimaryLinks.parameters?.docs,
    source: {
      ...
      ...PrimaryLinks.parameters?.docs?.source
    },
    description: {
      ...
      ...PrimaryLinks.parameters?.docs?.description
    }
  }
};
SecondaryLinks.parameters = {
  ...SecondaryLinks.parameters,
  docs: {
    ...SecondaryLinks.parameters?.docs,
    source: {
      originalSource: "{\n  render: args => <>\n      <Button {...args} label=\"Internal Link\" href=\"#internal-test\" />\n      <Button {...args} external label=\"External Link\" href=\"https://google.com\" />\n      <Button {...args} href=\"#internal-test\" label=\"Link W/ Icons\" iconLeft=\"/icons/edit/16.svg\" iconRight=\"/icons/edit/16.svg\" />\n    </>\n}",
      ...SecondaryLinks.parameters?.docs?.source
    }
  }
};
Buttons.parameters = {
...
const __namedExportsOrder = ["SampleButton", "PrimaryLinks", "SecondaryLinks", "Buttons"];
try {
    // @ts-ignore
    SampleButton.displayName = "SampleButton";
    // @ts-ignore
...
try {
    ...
    // @ts-ignore
    PrimaryLinks.__docgenInfo = { "description": "Below is a collection of the different states in which you can find C4 links. A button becomes a link once an `href` property is provided to the component.\n- __Internal__: An internal link handles in-app navigation.\n- __External__: An external link will open the provided href in a new tab.\n- __Icons__: All links can take icons on either (or both) sides of the label.\n\n__Link-specific props:__\n- `href`\n- `external`", "displayName": "PrimaryLinks", "props": {} };
    // @ts-ignore
    if (typeof STORYBOOK_REACT_CLASSES !== "undefined")
        // @ts-ignore
        STORYBOOK_REACT_CLASSES["src/components/Button/Button.stories.tsx#PrimaryLinks"] = { docgenInfo: PrimaryLinks.__docgenInfo, name: "PrimaryLinks", path: "src/components/Button/Button.stories.tsx#PrimaryLinks" };
}
catch (__react_docgen_typescript_loader_error) { }
try {
    // @ts-ignore
