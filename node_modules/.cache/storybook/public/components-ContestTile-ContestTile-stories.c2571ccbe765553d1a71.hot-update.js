...
const ContestTile = ({
  ...
  const [contestTimelineObject, setContestTimelineObject] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)((0,_utils_time__WEBPACK_IMPORTED_MODULE_3__.getDates)(new Date(startDate).toISOString(), new Date(endDate).toISOString()));
  ...
  const updateContestTileStatus = (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const newTimelineObject = (0,_utils_time__WEBPACK_IMPORTED_MODULE_3__.getDates)(new Date(startDate).toISOString(), new Date(endDate).toISOString());
...
//# sourceMappingURL=components-ContestTile-ContestTile-stories.c2571ccbe765553d1a71.hot-update.js.map